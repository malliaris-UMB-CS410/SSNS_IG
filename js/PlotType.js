...
class PlotType {
    ...
    constructor() {
        ...
        if (!this.plot)
            throw new Error("Derived PlotType must define plot()");
        if (!this.get_html_targ_id_str)
            throw new Error("Derived PlotType must define get_html_targ_id_str()");
        if (!this.get_plot_width)
            throw new Error("Derived PlotType must define get_plot_width()");
        if (!this.get_plot_height)
            throw new Error("Derived PlotType must define get_plot_height()");
        if (!this.get_ext_x_axis_lbl_str)
            throw new Error("Derived PlotType must define get_ext_x_axis_lbl_str()");
        if (!this.get_ext_y_axis_lbl_str)
            throw new Error("Derived PlotType must define get_ext_y_axis_lbl_str()");
    }
