...
class UserInterface {
    ...
    constructor(sim) {
        ...
        // Ideal Gas
        Params_IG.V = new UINI_int(this, "UI_P_SM_IG_V", true);     // Not sure this is params or coords and true or false - jg
    ...
    /**
     * Control whether plot_x_axis_lbl and plot_y_axis_lbl component display for not
     * IG mode: not showing
     */
    toggleAxisLabels() {
        const isIG = this.sim.ST === 'IG';
        const plot_x_axis_lbl = document.getElementById('plot_x_axis_lbl');
        const plot_y_axis_lbl = document.getElementById('plot_y_axis_lbl');

        if (isIG) {
            plot_x_axis_lbl.style.display = 'none';
            plot_y_axis_lbl.style.display = 'none';
        } else {
            plot_x_axis_lbl.style.display = 'block';
            plot_y_axis_lbl.style.display = 'block';
        }
    }
