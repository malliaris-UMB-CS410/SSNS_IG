...
class PlotTypeHM extends PlotType {
    ...
    constructor() {
        ...
        if (!this.get_color_from_spin_val)
            throw new Error("Derived PlotTypeHM must define get_color_from_spin_val()");
    ...
    setup_canvas_etc() {
        ...
        this.cc = document.getElementById(this.get_html_targ_id_str()).getContext("2d", {
            alpha: false
        }); // cc = canvas context, for plotting calls
