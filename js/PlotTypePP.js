...
class PlotTypePP extends PlotType {
    ...
    constructor() {
        ...
        if (!this.get_flot_data_series)
            throw new Error("Derived PlotTypePP must define get_flot_data_series()");
        if (!this.get_flot_gen_opts)
            throw new Error("Derived PlotTypePP must define get_flot_gen_opts()");
    }
        ...
        this.flot_gen_opts = {
            xaxis: {
                ...
                transform: function (v) {
                    return -v;
                }, // make the gingerbread-man easier to recognize by flipping axis
            },
            yaxis: {
                autoScale: "none",
                min: -4,
